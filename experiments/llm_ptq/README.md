...
- **H2 + Beta (ours)** (rotation + per-row L2 normalize + Beta codebook)
...
If 4-bit H2+Beta perplexity on WikiText-2 is within ~10% of FP16 perplexity
(and comparable to QuaRot), the method generalizes. If 2-bit H2+Beta is
