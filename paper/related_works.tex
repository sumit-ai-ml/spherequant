% =============================================================================
% Related Works section for the SphereQuant paper.
...
requirements. SphereQuant uses no calibration data, computes no gradients, and
...
can be layered on top of SphereQuant to future work.
...
Our SphereQuant method competes in this training-free tier alongside RTN-absmax
...
step and the codebook choice within this tier, and we position SphereQuant as
...
SphereQuant sits at the intersection of three literatures. It borrows the
...
rotation plus uniform quantization, SphereQuant gains additional accuracy
through rotation plus a distribution-matched codebook. Where
TurboQuant targets embedding compression, SphereQuant targets weight
compression. The empirical gap between SphereQuant and the closest prior method
